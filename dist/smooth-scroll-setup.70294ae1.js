...
},{"./Observer.js":"../node_modules/gsap/Observer.js"}],"../node_modules/locomotive-scroll/src/scripts/options.js":[function(require,module,exports) {
"use strict";
...
},{}],"../node_modules/locomotive-scroll/src/scripts/Core.js":[function(require,module,exports) {
"use strict";
...
},{"./options":"../node_modules/locomotive-scroll/src/scripts/options.js"}],"../node_modules/smoothscroll-polyfill/dist/smoothscroll.js":[function(require,module,exports) {
...
},{}],"../node_modules/locomotive-scroll/src/scripts/Native.js":[function(require,module,exports) {
"use strict";
...
class _default extends _Core.default {
  constructor(options = {}) {
    ...
    if (window.smoothscrollPolyfill === undefined) {
      window.smoothscrollPolyfill = _smoothscrollPolyfill.default;
...
exports.default = _default;
},{"./Core":"../node_modules/locomotive-scroll/src/scripts/Core.js","smoothscroll-polyfill":"../node_modules/smoothscroll-polyfill/dist/smoothscroll.js"}],"../node_modules/object-assign/index.js":[function(require,module,exports) {
/*
object-assign
(c) Sindre Sorhus
@license MIT
...
},{}],"../node_modules/locomotive-scroll/src/scripts/utils/transform.js":[function(require,module,exports) {
"use strict";
...
},{}],"../node_modules/locomotive-scroll/src/scripts/utils/html.js":[function(require,module,exports) {
"use strict";
...
},{}],"../node_modules/locomotive-scroll/src/scripts/Smooth.js":[function(require,module,exports) {
"use strict";
...
class _default extends _Core.default {
  ...
  updateScroll(e) {
    if (this.isScrolling || this.isDraggingScrollbar) {
      this.instance.scroll[this.directionAxis] = (0, _maths.lerp)(this.instance.scroll[this.directionAxis], this.instance.delta[this.directionAxis], this.lerp);
    } else {
  ...
  addElements() {
    ...
    els.forEach((el, index) => {
      ...
      const targetParents = (0, _html.getParents)(el);
      let section = Object.entries(this.sections).map(([key, section]) => section).find(section => targetParents.includes(section.el));
      let cl = el.dataset[this.name + 'Class'] || this.class;
      ...
      if (section === null) {
        top = targetElBCR.top + this.instance.scroll.y - (0, _transform.getTranslate)(targetEl).y;
        left = targetElBCR.left + this.instance.scroll.x - (0, _transform.getTranslate)(targetEl).x;
      } else {
        if (!section.inView) {
          top = targetElBCR.top - (0, _transform.getTranslate)(section.el).y - (0, _transform.getTranslate)(targetEl).y;
          left = targetElBCR.left - (0, _transform.getTranslate)(section.el).x - (0, _transform.getTranslate)(targetEl).x;
        } else {
          top = targetElBCR.top + this.instance.scroll.y - (0, _transform.getTranslate)(targetEl).y;
          left = targetElBCR.left + this.instance.scroll.x - (0, _transform.getTranslate)(targetEl).x;
        }
  ...
  addSections() {
    ...
    sections.forEach((section, index) => {
      ...
      let offset = {
        x: sectionBCR.left - window.innerWidth * 1.5 - (0, _transform.getTranslate)(section).x,
        y: sectionBCR.top - window.innerHeight * 1.5 - (0, _transform.getTranslate)(section).y
      };
      let limit = {
  ...
  transform(element, x, y, delay) {
    ...
    if (!delay) {
      ...
      let start = (0, _transform.getTranslate)(element);
      let lerpX = (0, _maths.lerp)(start.x, x, delay);
      let lerpY = (0, _maths.lerp)(start.y, y, delay);
  ...
  scrollTo(target, options = {}) {
    ...
    easing = (0, _bezierEasing.default)(...easing);
    ...
    if (typeof target !== 'number') {
      ...
      let targetInScope = (0, _html.getParents)(target).includes(this.el);
      ...
      const offsetLeft = targetBCR.left; // Try and find the target's parent section

      const targetParents = (0, _html.getParents)(target);
      ...
      if (parentSection) {
        parentSectionOffset = (0, _transform.getTranslate)(parentSection)[this.directionAxis]; // We got a parent section, store it's current offset to remove it later
      } else {
...
exports.default = _default;
},{"virtual-scroll":"../node_modules/virtual-scroll/src/index.js","./Core":"../node_modules/locomotive-scroll/src/scripts/Core.js","./utils/maths":"../node_modules/locomotive-scroll/src/scripts/utils/maths.js","./utils/transform":"../node_modules/locomotive-scroll/src/scripts/utils/transform.js","./utils/html":"../node_modules/locomotive-scroll/src/scripts/utils/html.js","bezier-easing":"../node_modules/bezier-easing/src/index.js"}],"../node_modules/locomotive-scroll/src/scripts/Main.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = exports.Smooth = void 0;
...
var _default = Smooth;
exports.default = _default;
},{"./options":"../node_modules/locomotive-scroll/src/scripts/options.js","./Native":"../node_modules/locomotive-scroll/src/scripts/Native.js","./Smooth":"../node_modules/locomotive-scroll/src/scripts/Smooth.js"}],"../node_modules/locomotive-scroll/src/scripts/NativeMain.js":[function(require,module,exports) {
"use strict";
...
},{"./options":"../node_modules/locomotive-scroll/src/scripts/options.js","./Native":"../node_modules/locomotive-scroll/src/scripts/Native.js"}],"../node_modules/locomotive-scroll/src/locomotive-scroll.js":[function(require,module,exports) {
"use strict";
...
var _Main = _interopRequireWildcard(require("./scripts/Main"));
...
},{"./scripts/Main":"../node_modules/locomotive-scroll/src/scripts/Main.js","./scripts/NativeMain":"../node_modules/locomotive-scroll/src/scripts/NativeMain.js"}],"js/smooth-scroll-setup.js":[function(require,module,exports) {
"use strict";
...
var _locomotiveScroll = _interopRequireDefault(require("locomotive-scroll/src/locomotive-scroll"));
...
_ScrollTrigger.default.scrollerProxy(".scroll-container", {
...
_ScrollTrigger.default.refresh(); //watch the free video on how this demo was made
// https://www.snorkl.tv/scrolltrigger-smooth-scroll/
},{"gsap":"../node_modules/gsap/index.js","gsap/ScrollTrigger":"../node_modules/gsap/ScrollTrigger.js","locomotive-scroll/src/locomotive-scroll":"../node_modules/locomotive-scroll/src/locomotive-scroll.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/smooth-scroll-setup.js"], null)
//# sourceMappingURL=/smooth-scroll-setup.70294ae1.js.map